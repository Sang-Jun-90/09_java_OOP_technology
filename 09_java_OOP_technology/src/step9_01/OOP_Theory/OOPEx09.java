...
public class OOPEx09 {
	...
	public static void main(String[] args) {
		...
		Sub sub1 = new Sub();// 자식클래스 객체생성
		sub1.baseMethod(); // 상속받은 메서드 사용
		sub1.subMethod(); // 자신의 메서드사용
		...
		[3] sub은 Base 로 형변환이 가능하고, 		
		[4] base 는 Sub 으로 형변환이 불가능하다.	
	
	 */	
		
		Base sub2 = new Sub();
		sub2.baseMethod();   	// 객체의 타입이 부모형태이기 떄문에
								// 부모클래스가 소유하고 있는 메서드만 사용가능
